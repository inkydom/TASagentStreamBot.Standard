...
BGC.IO.DataManagement.Initialize("TASagentBotStandard");
...
//Custom Database
builder.Services
    .AddTASDbContext<TASagentTwitchBot.Standard.Database.DatabaseContext>();
...
//Custom EventSub
builder.Services
    .AddTASSingleton<TASagentTwitchBot.Standard.EventSub.TestLiveListener>();
...
//Custom Commands
builder.Services
    .AddTASSingleton<TASagentTwitchBot.Standard.Commands.UpTimeSystem>();
...
builder.Services
    .AddTASSingleton(TASagentTwitchBot.Standard.PointsSpender.PointSpenderConfiguration.GetConfig())
    .AddTASSingleton<TASagentTwitchBot.Standard.PointsSpender.PointSpenderHandler>()
    .AddTASSingleton<TASagentTwitchBot.Standard.PointsSpender.PointsSpenderSystem>();
...
{
    TASagentTwitchBot.Standard.Database.DatabaseContext context = serviceScope.ServiceProvider!.GetRequiredService<TASagentTwitchBot.Standard.Database.DatabaseContext>();
